        ...
        <>
          ...
          <SectionCard title="導入告知テンプレート">
            <div className="grid gap-3 text-sm leading-7 text-muted-foreground">
              <p>
                curacuri.ai は、運営が質問、要望、不具合報告、不満を見落とさないためのAI書記です。
                読み取り対象は管理者が指定した公開チャンネルのみです。分析対象外に指定したチャンネルとDMは読みません。
              </p>
              <p>
                保存する情報は、投稿本文、投稿日時、チャンネル、スレッド、匿名化した投稿者ID、分類結果、運営向け通知、自動返信案、FAQ候補、週次レポート、管理者フィードバックです。
                保存期間はサーバー設定に従い、初期値は短めにしています。削除依頼はサーバー管理者へ連絡してください。
              </p>
              <p>
                自動返信は管理者がONにした場合だけ、許可されたチャンネル、ラベル、回答カテゴリで実行されます。
                法務、広報、料金、障害、ロードマップ、個別アカウント、課金、セキュリティ、ルール処分、公式判断が必要な投稿には返信せず、運営者確認に回します。
              </p>
              <p>
                自動返信はAIキャラクターによる補助回答であり、公式回答とは分離されます。
                ユーザー評価、採点、自動BAN、自動処分は行わず、管理者向けに話題と確認事項を整理する目的でのみ使います。
              </p>
            </div>
          </SectionCard>
        </>

...
本文は1〜3文に収め、断定、約束、謝罪の代行、原因推測、未確認の手順追加を避けてください。
運営に届くこと、確認中であること、公開済み情報への案内だけを自然な日本語で返してください。
...
同じ質問や近い論点は1候補へまとめ、1候補は1つの質問と1つの回答文案だけを扱ってください。
一時的な雑談、単発の感想、根拠の薄い推測はFAQ候補にしないでください。
...
短い版は最大5項目、各項目は1〜2文にし、詳細な根拠や全文引用は詳細版へ回してください。
短い版では「まず確認すべきこと」「増えている声」「次の行動」を優先し、既知情報の反復を避けてください。
